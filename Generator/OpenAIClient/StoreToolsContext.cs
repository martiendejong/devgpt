...
//            new Tool()
//            {
//                FunctionName = nameof(PerformConvertStorePdfFile),
//                Definition = getConvertStorePdfFileTool,
//                Execute = async (List<ChatMessage> messages, ChatToolCall toolCall) =>
//                {
//                    using JsonDocument argumentsJson = JsonDocument.Parse(toolCall.FunctionArguments);
//                    bool hasQuery = argumentsJson.RootElement.TryGetProperty("file", out JsonElement query);
//                    if (hasQuery)
//                    {
//                        return await PerformConvertStorePdfFile(query.GetString());
//                    }
//                    return "Invalid call, parameter file was not provided.";
//                }
//            },
//            new Tool()
//            {
//                FunctionName = nameof(PerformConvertChatPdfFile),
//                Definition = getConvertChatPdfFileTool,
//                Execute = async (List<ChatMessage> messages, ChatToolCall toolCall) =>
//                {
//                    using JsonDocument argumentsJson = JsonDocument.Parse(toolCall.FunctionArguments);
//                    bool hasQuery = argumentsJson.RootElement.TryGetProperty("file", out JsonElement query);
//                    if (hasQuery)
//                    {
//                        return await PerformConvertChatPdfFile(query.GetString());
//                    }
//                    return "Invalid call, parameter file was not provided.";
//                }
//            },
...
//    private static readonly ChatTool getConvertStorePdfFileTool = ChatTool.CreateFunctionTool(
//        functionName: nameof(PerformReadStoreFile),
//        functionDescription: "Converts the store Pdf file to images and generates a textual description of those images.",
//        functionParameters: BinaryData.FromBytes("""
//        {
//            "type": "object",
//            "properties": {
//                "file": {
//                    "type": "string",
//                    "description": "The path of the store file to read."
//                }
//            },
//            "required": ["file"]
//        }
...
//    private static readonly ChatTool getConvertChatPdfFileTool = ChatTool.CreateFunctionTool(
//        functionName: nameof(PerformReadStoreFile),
//        functionDescription: "Converts the Pdf file attached to the chat to images and generates a textual description of those images.",
//        functionParameters: BinaryData.FromBytes("""
//        {
//            "type": "object",
//            "properties": {
//                "file": {
//                    "type": "string",
//                    "description": "The path of the attached file to read."
//                }
//            },
//            "required": ["file"]
//        }
...
//    private async Task<string> PerformConvertStorePdfFile(string file)
//    {
//        TextFileExtractor.
//        AnalyzePdfAsImages
//    }

//    private async Task<string> PerformConvertChatPdfFile(string file)
//    {
//        AnalyzePdfAsImages
//    }
